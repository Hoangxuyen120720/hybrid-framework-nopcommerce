...
public class Level_02_ApplyBasepage_03_Inheritance extends BasePage {
	...
	public void Register_02_Invalid_Email() {
		...
		sendKeyToElement(driver, "//input[@id='FirstName']", "Xuyen");
		sendKeyToElement(driver, "//input[@id='LastName']", "Hoang");
		sendKeyToElement(driver, "//input[@id='Email']", "Xuyen@123@@");
	...
	public void Register_03_Invalid_Password() {
		...
		sendKeyToElement(driver, "//input[@id='FirstName']", "Xuyen");
		sendKeyToElement(driver, "//input[@id='LastName']", "Hoang");
		sendKeyToElement(driver, "//input[@id='Email']", "Xuyen@gmail.com");
